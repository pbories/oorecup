        ...
        <div class="main-search">
          <div class="form-filters">
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="cell selector">
                  <?php osclasswizards_regions_select('sRegion', 'sRegion', __('Choisir une région', OSCLASSWIZARDS_THEME_FOLDER)) ; ?>
                </div>
              </div>
              <div class="col-md-2">
                <div class="cell selector">
                  <?php osclasswizards_cities_select('sCity', 'sCity', __('Choisir une ville', OSCLASSWIZARDS_THEME_FOLDER)) ; ?>
                </div>
              </div>
