          ...
          <div class="filters">
            <form action="<?php echo osc_base_url(true); ?>" method="get" class="nocsrf">
              ...
              <fieldset>
                ...
                <div>
				 <?php osclasswizards_countries_select('sCountry', 'sCountry', __('Choisir un pays', OSCLASSWIZARDS_THEME_FOLDER), osc_esc_html(Params::getParam('sCountry')));?>
                </div>
              </fieldset>
			  <?php } ?>
			    <fieldset>
                ...
                <div>
					<?php osclasswizards_regions_select('sRegion', 'sRegion', __('Choisir une région', OSCLASSWIZARDS_THEME_FOLDER), osc_esc_html(osc_search_region())) ; ?>
                </div>
              </fieldset>
			  <fieldset>
                <h3>
                ...
                <div>
                    <?php osclasswizards_cities_select('sCity', 'sCity', __('Choisir une ville', OSCLASSWIZARDS_THEME_FOLDER), osc_esc_html(osc_search_city())) ; ?>
                </div>
              </fieldset>
